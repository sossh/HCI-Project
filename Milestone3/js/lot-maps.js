...
var parkingLots = {
  ...
  specialSpots: [
    ...
    { row: 0, col: 10, features: ["empty"], price: 0 },
    { row: 0, col: 11, features: ["empty"], price: 0 },
    { row: 0, col: 12, features: ["empty"], price: 0 },
  ...
  Parkade: {
    ...
    specialSpots: [
      ...
      { row: 15, col: 13, features: ["covered"], price: 4 },
      { row: 15, col: 14, features: ["covered"], price: 4 },
